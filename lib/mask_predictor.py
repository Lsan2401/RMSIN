...
class SimpleDecoding(nn.Module):
    def __init__(self, c4_dims, factor=2):
        ...
        routing_function1 = RountingFunction(in_channels=hidden_size, kernel_number=4)
        self.conv2_4 = AdaptiveRotatedConv2d(in_channels=hidden_size, out_channels=hidden_size,
                                                     kernel_size=3, padding=1, rounting_func=routing_function1, bias=False, kernel_number=4)
        ...
        routing_function2 = RountingFunction(in_channels=hidden_size, kernel_number=4)
        ...
        routing_function3 = RountingFunction(in_channels=hidden_size, kernel_number=4)
